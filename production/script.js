...
.then(dataFromFirstFetch => {
 ...
 function renderProducts(products) {
        ...
        link.href = `details_uri.html?name=${encodeURIComponent(product.name)}&price=${encodeURIComponent(product.price.replace('₦','').replace('$','').replace('CFA','')}&image_url=${encodeURIComponent(product.item_image)}`;
